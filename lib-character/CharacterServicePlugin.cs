...
public class CharacterServicePlugin : BaseBannouPlugin
{
    ...
    protected override async Task<bool> OnStartAsync()
    {
        ...
        try
        {
            ...
            {
                Logger?.LogDebug("Calling IBannouService.OnStartAsync for Character service");
    ...
    protected override async Task OnRunningAsync()
    {
        ...
        try
        {
            if (_service is IBannouService bannouService)
            {
                Logger?.LogDebug("Calling IBannouService.OnRunningAsync for Character service");
    ...
    protected override async Task OnShutdownAsync()
    {
        ...
        try
        {
            if (_service is IBannouService bannouService)
            {
                Logger?.LogDebug("Calling IBannouService.OnShutdownAsync for Character service");
