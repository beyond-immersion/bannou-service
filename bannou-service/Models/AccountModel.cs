...
/// <summary>
/// Implementation of a user account data model.
/// See also: <seealso cref="IAccountModel"/> and <seealso cref="AccountService"/>
/// </summary>
[JsonObject(MemberSerialization = MemberSerialization.OptIn)]
public sealed class AccountModel : IAccountModel
{
    /// <summary>
    ...
    public AccountModel(string id, string email, string hashedSecret, string secretSalt, string displayName, string role = "user")
    {
