...
/// Values can be initialized from <see cref="CognitionConfiguration"/>
...
/// Call <see cref="Initialize"/> once at service startup.
/// </para>
/// <para>
/// If <see cref="Initialize"/> is not called, default values are used.
/// </para>
/// </remarks>
public static class CognitionConstants
{
    ...
    /// <summary>
    /// Initializes cognition constants from configuration.
    /// Should be called once at service startup.
    /// </summary>
    /// <param name="config">The cognition configuration.</param>
    /// <remarks>
    ...
    /// </remarks>
    public static void Initialize(CognitionConfiguration config)
    {
        if (_isInitialized)
            return;
