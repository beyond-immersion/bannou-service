...
public partial class FollowerResponse
{
    ...
    /// <summary>
    /// Whether an attention slot was allocated for this follower (false if deity at max attention capacity)
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("attentionSlotAllocated")]
    public bool AttentionSlotAllocated { get; set; } = default!;
