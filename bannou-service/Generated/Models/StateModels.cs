...
/// <summary>
/// Request to save a state value to a state store with optional TTL and optimistic concurrency
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.5.0.0 (NJsonSchema v11.4.0.0 (Newtonsoft.Json v13.0.0.0))")]
public partial class SaveStateRequest
{
    ...
    /// <summary>
    /// Expected ETag for optimistic concurrency - save fails with 409 Conflict if mismatch
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("etag")]
    [System.ComponentModel.DataAnnotations.StringLength(100, MinimumLength = 1)]
    public string? Etag { get; set; } = default!;
    ...
    /// <summary>
    /// Optional settings for the save operation including TTL
    /// </summary>
...
/// <summary>
/// Configuration options for state save operations including TTL
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.5.0.0 (NJsonSchema v11.4.0.0 (Newtonsoft.Json v13.0.0.0))")]
