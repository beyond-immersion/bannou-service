...
public partial class EscrowAgreement
{
    ...
    public string? TrustedPartyType { get; set; } = default!;
...
public partial class ReleaseAllocation
{
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonRequired]
    public string RecipientPartyType { get; set; } = default!;
...
public partial class ValidationFailure
{
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonRequired]
    public string AffectedPartyType { get; set; } = default!;
...
public partial class VerifyConditionRequest
{
    ...
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonRequired]
    public string VerifierType { get; set; } = default!;
...
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.5.0.0 (NJsonSchema v11.4.0.0 (Newtonsoft.Json v13.0.0.0))")]
public partial class EscrowServiceConfiguration
{

    /// <summary>
    /// Default escrow expiration if not specified (ISO 8601 duration)
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("defaultTimeout")]
    public string DefaultTimeout { get; set; } = "P7D";

    /// <summary>
    /// Maximum allowed escrow duration (ISO 8601 duration)
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("maxTimeout")]
    public string MaxTimeout { get; set; } = "P30D";

    /// <summary>
    /// Grace period after expiration before auto-refund (ISO 8601 duration)
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("expirationGracePeriod")]
    public string ExpirationGracePeriod { get; set; } = "PT1H";

    /// <summary>
    /// Algorithm used for token generation
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("tokenAlgorithm")]
    [System.Text.Json.Serialization.JsonConverter(typeof(System.Text.Json.Serialization.JsonStringEnumConverter))]
    public EscrowServiceConfigurationTokenAlgorithm TokenAlgorithm { get; set; } = BeyondImmersion.BannouService.Escrow.EscrowServiceConfigurationTokenAlgorithm.Hmac_sha256;

    /// <summary>
    /// Token length in bytes (before encoding)
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("tokenLength")]
    public int TokenLength { get; set; } = 32;

    /// <summary>
    /// Token secret for HMAC (must be set in production)
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("tokenSecret")]
    public string TokenSecret { get; set; } = default!;

    /// <summary>
    /// How often to check for expired escrows (ISO 8601 duration)
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("expirationCheckInterval")]
    public string ExpirationCheckInterval { get; set; } = "PT1M";

    /// <summary>
    /// Batch size for expiration processing
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("expirationBatchSize")]
    public int ExpirationBatchSize { get; set; } = 100;

    /// <summary>
    /// How often to validate held assets (ISO 8601 duration)
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("validationCheckInterval")]
    ...
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("maxAssetsPerDeposit")]
    public int MaxAssetsPerDeposit { get; set; } = 50;

    /// <summary>
    /// Maximum concurrent pending escrows per party
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("maxPendingPerParty")]
...
#pragma warning disable CS1591 // Enum members cannot have XML documentation
[System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.5.0.0 (NJsonSchema v11.4.0.0 (Newtonsoft.Json v13.0.0.0))")]
public enum EscrowServiceConfigurationTokenAlgorithm
{
