...
public partial class RealmCreatedEvent : BaseServiceEvent
{
    ...
    /// <summary>
    /// Timestamp when the realm was last updated (set to createdAt on creation)
    /// </summary>
