...
public partial class LicenseBoardTemplateCreatedEvent : BaseServiceEvent
{
    ...
    /// <summary>
    /// Timestamp when the license board template was last updated (set to createdAt on creation)
    /// </summary>
    ...
    /// <summary>
    /// Whether this license board template is deprecated
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("isDeprecated")]
    public bool IsDeprecated { get; set; } = default!;

    /// <summary>
    /// When the license board template was deprecated (null if not deprecated)
    /// </summary>
...
public partial class LicenseBoardCreatedEvent : BaseServiceEvent
{
    ...
    /// <summary>
    /// Timestamp when the license board was last updated (set to createdAt on creation)
    /// </summary>
    [System.Text.Json.Serialization.JsonPropertyName("updatedAt")]
    [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
    [System.Text.Json.Serialization.JsonRequired]
