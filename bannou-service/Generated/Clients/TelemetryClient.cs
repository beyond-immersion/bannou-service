...
/// <summary>
/// Client interface for the Telemetry service.
...
public partial interface ITelemetryClient
{
    ...
    System.Threading.Tasks.Task<TelemetryHealthResponse> HealthAsync(TelemetryHealthRequest? body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<TelemetryStatusResponse> StatusAsync(TelemetryStatusRequest? body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
}

/// <summary>
/// Client implementation for the Telemetry service.
/// Provides strongly-typed methods for invoking service endpoints via the mesh infrastructure.
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("NSwag", "14.5.0.0 (NJsonSchema v11.4.0.0 (Newtonsoft.Json v13.0.0.0))")]
public partial class TelemetryClient : ITelemetryClient, BeyondImmersion.BannouService.ServiceClients.IServiceClient<TelemetryClient>
{
    ...
    private readonly Microsoft.Extensions.Logging.ILogger<TelemetryClient>? _logger;
    ...
    /// </summary>
    private static readonly string _serviceName = "telemetry";
    ...
    public TelemetryClient(BeyondImmersion.BannouService.Services.IMeshInvocationClient meshClient, BeyondImmersion.BannouService.Services.IServiceAppMappingResolver resolver, Microsoft.Extensions.Logging.ILogger<TelemetryClient>? logger = null, System.IServiceProvider? directDispatchProvider = null)
    {
    ...
    public TelemetryClient WithAuthorization(string? token)
    {
    ...
    /// <returns>Telemetry health status</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<TelemetryHealthResponse> HealthAsync(TelemetryHealthRequest? body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        // Operation Path: "telemetry/health"
        urlBuilder_.Append("telemetry/health");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<TelemetryHealthResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    /// <returns>Telemetry status</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<TelemetryStatusResponse> StatusAsync(TelemetryStatusRequest? body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        // Direct dispatch path: resolve service from DI and call directly (embedded/sidecar mode)
        if (_directDispatchProvider != null)
        {
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "telemetry/status"
        urlBuilder_.Append("telemetry/status");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<TelemetryStatusResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new BeyondImmersion.Bannou.Core.ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
