...
public partial interface IRelationshipClient
{
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<CleanupByEntityResponse> CleanupByEntityAsync(CleanupByEntityRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
...
public partial class RelationshipClient : IRelationshipClient, BeyondImmersion.BannouService.ServiceClients.IServiceClient<RelationshipClient>
{
    ...
    public RelationshipClient(BeyondImmersion.BannouService.Services.IMeshInvocationClient meshClient, BeyondImmersion.BannouService.Services.IServiceAppMappingResolver resolver, Microsoft.Extensions.Logging.ILogger<RelationshipClient>? logger = null, System.IServiceProvider? directDispatchProvider = null)
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 400)
                    {
                        ...
                        throw new BeyondImmersion.Bannou.Core.ApiException("Invalid request (missing fields, invalid entity types)", status_, responseText_, headers_, null);
                    }
                    else
                    if (status_ == 409)
                    {
                        string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                        throw new BeyondImmersion.Bannou.Core.ApiException("Relationship already exists between these entities with this type", status_, responseText_, headers_, null);
                    }
                    else
                    {
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                        throw new BeyondImmersion.Bannou.Core.ApiException("Relationship not found", status_, responseText_, headers_, null);
                    }
                    else
                    {
                        var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
    ...
    /// <returns>Cleanup completed</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<CleanupByEntityResponse> CleanupByEntityAsync(CleanupByEntityRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "relationship/cleanup-by-entity"
        urlBuilder_.Append("relationship/cleanup-by-entity");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<CleanupByEntityResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new BeyondImmersion.Bannou.Core.ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
