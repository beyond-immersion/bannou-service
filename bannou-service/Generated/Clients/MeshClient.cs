...
public partial class MeshClient : IMeshClient, BeyondImmersion.BannouService.ServiceClients.IServiceClient<MeshClient>
{
    ...
    public MeshClient(BeyondImmersion.BannouService.Services.IMeshInvocationClient meshClient, BeyondImmersion.BannouService.Services.IServiceAppMappingResolver resolver, Microsoft.Extensions.Logging.ILogger<MeshClient>? logger = null, System.IServiceProvider? directDispatchProvider = null)
    {
    ...
    public virtual async System.Threading.Tasks.Task<GetEndpointsResponse> GetEndpointsAsync(GetEndpointsRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        {
            return await BeyondImmersion.BannouService.ServiceClients.DirectDispatchHelper.InvokeDirectAsync<IMeshService, GetEndpointsRequest, GetEndpointsResponse>(
                _directDispatchProvider,
                body,
                static (svc, req, ct) => svc.GetEndpointsAsync(req, ct),
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 404)
                    {
                        ...
                        throw new BeyondImmersion.Bannou.Core.ApiException("No endpoints found for app-id", status_, responseText_, headers_, null);
                    }
                    else
                    {
    ...
    public virtual async System.Threading.Tasks.Task<ListEndpointsResponse> ListEndpointsAsync(ListEndpointsRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        if (_directDispatchProvider != null)
        {
            return await BeyondImmersion.BannouService.ServiceClients.DirectDispatchHelper.InvokeDirectAsync<IMeshService, ListEndpointsRequest, ListEndpointsResponse>(
                _directDispatchProvider,
                body,
                static (svc, req, ct) => svc.ListEndpointsAsync(req, ct),
                cancellationToken).ConfigureAwait(false);
        }
    ...
    public virtual async System.Threading.Tasks.Task<RegisterEndpointResponse> RegisterEndpointAsync(RegisterEndpointRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        if (_directDispatchProvider != null)
        {
            return await BeyondImmersion.BannouService.ServiceClients.DirectDispatchHelper.InvokeDirectAsync<IMeshService, RegisterEndpointRequest, RegisterEndpointResponse>(
                _directDispatchProvider,
                body,
                static (svc, req, ct) => svc.RegisterEndpointAsync(req, ct),
                cancellationToken).ConfigureAwait(false);
        }
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                        throw new BeyondImmersion.Bannou.Core.ApiException("Invalid registration data", status_, responseText_, headers_, null);
                    }
                    else
                    {
                        var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async System.Threading.Tasks.Task<DeregisterEndpointResponse> DeregisterEndpointAsync(DeregisterEndpointRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        if (_directDispatchProvider != null)
        {
            return await BeyondImmersion.BannouService.ServiceClients.DirectDispatchHelper.InvokeDirectAsync<IMeshService, DeregisterEndpointRequest, DeregisterEndpointResponse>(
                _directDispatchProvider,
                body,
                static (svc, req, ct) => svc.DeregisterEndpointAsync(req, ct),
                cancellationToken).ConfigureAwait(false);
        }
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                        throw new BeyondImmersion.Bannou.Core.ApiException("Endpoint not found", status_, responseText_, headers_, null);
                    }
                    else
                    {
                        var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async System.Threading.Tasks.Task<HeartbeatResponse> HeartbeatAsync(HeartbeatRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        if (_directDispatchProvider != null)
        {
            return await BeyondImmersion.BannouService.ServiceClients.DirectDispatchHelper.InvokeDirectAsync<IMeshService, HeartbeatRequest, HeartbeatResponse>(
                _directDispatchProvider,
                body,
                static (svc, req, ct) => svc.HeartbeatAsync(req, ct),
                cancellationToken).ConfigureAwait(false);
        }
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                        throw new BeyondImmersion.Bannou.Core.ApiException("Endpoint not registered", status_, responseText_, headers_, null);
                    }
                    else
                    {
                        var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async System.Threading.Tasks.Task<GetRouteResponse> GetRouteAsync(GetRouteRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        if (_directDispatchProvider != null)
        {
            return await BeyondImmersion.BannouService.ServiceClients.DirectDispatchHelper.InvokeDirectAsync<IMeshService, GetRouteRequest, GetRouteResponse>(
                _directDispatchProvider,
                body,
                static (svc, req, ct) => svc.GetRouteAsync(req, ct),
                cancellationToken).ConfigureAwait(false);
        }
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                        throw new BeyondImmersion.Bannou.Core.ApiException("No healthy endpoints available for the requested app-id", status_, responseText_, headers_, null);
                    }
                    else
                    {
                        var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async System.Threading.Tasks.Task<GetMappingsResponse> GetMappingsAsync(GetMappingsRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        if (_directDispatchProvider != null)
        {
            return await BeyondImmersion.BannouService.ServiceClients.DirectDispatchHelper.InvokeDirectAsync<IMeshService, GetMappingsRequest, GetMappingsResponse>(
                _directDispatchProvider,
                body,
                static (svc, req, ct) => svc.GetMappingsAsync(req, ct),
                cancellationToken).ConfigureAwait(false);
        }
    ...
    public virtual async System.Threading.Tasks.Task<MeshHealthResponse> GetHealthAsync(GetHealthRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        if (_directDispatchProvider != null)
        {
            return await BeyondImmersion.BannouService.ServiceClients.DirectDispatchHelper.InvokeDirectAsync<IMeshService, GetHealthRequest, MeshHealthResponse>(
                _directDispatchProvider,
                body,
                static (svc, req, ct) => svc.GetHealthAsync(req, ct),
                cancellationToken).ConfigureAwait(false);
        }
