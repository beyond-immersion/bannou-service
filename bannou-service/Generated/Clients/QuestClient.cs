...
public partial interface IQuestClient
{
    ...
    /// <br/>No new quest instances can be created from deprecated definitions.
    /// </remarks>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
    /// <summary>
    /// Clean deprecated quest definitions with zero remaining instances
    /// </summary>
    /// <remarks>
    /// Category B cleanup sweep (per IMPLEMENTATION TENETS). Iterates all deprecated
    /// <br/>quest definitions and permanently removes those with zero remaining active quest
    /// <br/>instances, subject to an optional grace period. Publishes quest-definition.deleted
    /// <br/>events for each removed definition. Idempotent and safe to call at any frequency.
    /// <br/>Supports dry-run mode for admin panel preview.
    /// </remarks>
    /// <returns>Cleanup sweep completed</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<CleanDeprecatedResponse> CleanDeprecatedQuestDefinitionsAsync(CleanDeprecatedRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <br/>Rejects with 400 if definition is deprecated.
    /// </remarks>
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<QuestInstanceResponse> DeleteQuestInstanceAsync(DeleteQuestInstanceRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
...
public partial class QuestClient : IQuestClient, BeyondImmersion.BannouService.ServiceClients.IServiceClient<QuestClient>
{
    ...
    public QuestClient(BeyondImmersion.BannouService.Services.IMeshInvocationClient meshClient, BeyondImmersion.BannouService.Services.IServiceAppMappingResolver resolver, Microsoft.Extensions.Logging.ILogger<QuestClient>? logger = null, System.IServiceProvider? directDispatchProvider = null)
    {
    ...
    /// <returns>Cleanup sweep completed</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<CleanDeprecatedResponse> CleanDeprecatedQuestDefinitionsAsync(CleanDeprecatedRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "quest/definition/clean-deprecated"
        urlBuilder_.Append("quest/definition/clean-deprecated");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                        throw new BeyondImmersion.Bannou.Core.ApiException("Prerequisites not met, already at max quests, or definition is deprecated", status_, responseText_, headers_, null);
                    }
                    else
                    if (status_ == 404)
                    {
    ...
    /// <returns>Quest instance deleted</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<QuestInstanceResponse> DeleteQuestInstanceAsync(DeleteQuestInstanceRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "quest/instance/delete"
        urlBuilder_.Append("quest/instance/delete");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    {
                        string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                        throw new BeyondImmersion.Bannou.Core.ApiException("Quest instance not found", status_, responseText_, headers_, null);
                    }
                    else
                    {
                        var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async System.Threading.Tasks.Task<DeleteByCharacterResponse> DeleteByCharacterAsync(DeleteByCharacterRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "quest/delete-by-character"
        urlBuilder_.Append("quest/delete-by-character");
