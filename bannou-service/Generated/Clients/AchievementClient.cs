...
/// <summary>
/// Client interface for the Achievement service.
...
public partial interface IAchievementClient
{
    ...
    System.Threading.Tasks.Task<AchievementDefinitionResponse> CreateAchievementDefinitionAsync(CreateAchievementDefinitionRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<AchievementDefinitionResponse> GetAchievementDefinitionAsync(GetAchievementDefinitionRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<ListAchievementDefinitionsResponse> ListAchievementDefinitionsAsync(ListAchievementDefinitionsRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<AchievementDefinitionResponse> UpdateAchievementDefinitionAsync(UpdateAchievementDefinitionRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
    /// <summary>
    /// Clean deprecated achievement definitions with zero remaining progress
    /// </summary>
    /// <remarks>
    /// Category B cleanup sweep (per IMPLEMENTATION TENETS). Iterates all deprecated
    /// <br/>achievement definitions and permanently removes those with zero remaining progress
    /// <br/>records, subject to an optional grace period. Publishes achievement-definition.deleted
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<CleanDeprecatedStringKeyResponse> CleanDeprecatedAchievementDefinitionsAsync(CleanDeprecatedRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<AchievementProgressResponse> GetAchievementProgressAsync(GetAchievementProgressRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<UpdateAchievementProgressResponse> UpdateAchievementProgressAsync(UpdateAchievementProgressRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<UnlockAchievementResponse> UnlockAchievementAsync(UnlockAchievementRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<ListUnlockedAchievementsResponse> ListUnlockedAchievementsAsync(ListUnlockedAchievementsRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<SyncPlatformAchievementsResponse> SyncPlatformAchievementsAsync(SyncPlatformAchievementsRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    System.Threading.Tasks.Task<PlatformSyncStatusResponse> GetPlatformSyncStatusAsync(GetPlatformSyncStatusRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
...
/// <summary>
/// Client implementation for the Achievement service.
/// Provides strongly-typed methods for invoking service endpoints via the mesh infrastructure.
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("NSwag", "14.5.0.0 (NJsonSchema v11.4.0.0 (Newtonsoft.Json v13.0.0.0))")]
public partial class AchievementClient : IAchievementClient, BeyondImmersion.BannouService.ServiceClients.IServiceClient<AchievementClient>
{
    ...
    private readonly Microsoft.Extensions.Logging.ILogger<AchievementClient>? _logger;
    ...
    /// </summary>
    private static readonly string _serviceName = "achievement";
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AchievementClient"/> class.
    /// </summary>
    ...
    public AchievementClient(BeyondImmersion.BannouService.Services.IMeshInvocationClient meshClient, BeyondImmersion.BannouService.Services.IServiceAppMappingResolver resolver, Microsoft.Extensions.Logging.ILogger<AchievementClient>? logger = null, System.IServiceProvider? directDispatchProvider = null)
    {
    ...
    public AchievementClient WithAuthorization(string? token)
    {
    ...
    /// <returns>Achievement created successfully</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<AchievementDefinitionResponse> CreateAchievementDefinitionAsync(CreateAchievementDefinitionRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
        ...
        // Operation Path: "achievement/definition/create"
        urlBuilder_.Append("achievement/definition/create");
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 409)
                    {
                        ...
                        throw new BeyondImmersion.Bannou.Core.ApiException("Achievement with this ID already exists", status_, responseText_, headers_, null);
                    }
                    else
                    {
    ...
    /// <returns>Achievement definition retrieved successfully</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<AchievementDefinitionResponse> GetAchievementDefinitionAsync(GetAchievementDefinitionRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/definition/get"
        urlBuilder_.Append("achievement/definition/get");
    ...
    /// <returns>Achievement definitions retrieved successfully</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<ListAchievementDefinitionsResponse> ListAchievementDefinitionsAsync(ListAchievementDefinitionsRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/definition/list"
        urlBuilder_.Append("achievement/definition/list");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<ListAchievementDefinitionsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new BeyondImmersion.Bannou.Core.ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    /// <returns>Achievement updated successfully</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<AchievementDefinitionResponse> UpdateAchievementDefinitionAsync(UpdateAchievementDefinitionRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/definition/update"
        urlBuilder_.Append("achievement/definition/update");
    ...
    /// <returns>Cleanup sweep completed</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<CleanDeprecatedStringKeyResponse> CleanDeprecatedAchievementDefinitionsAsync(CleanDeprecatedRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/definition/clean-deprecated"
        urlBuilder_.Append("achievement/definition/clean-deprecated");
    ...
    /// <returns>Progress retrieved successfully</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<AchievementProgressResponse> GetAchievementProgressAsync(GetAchievementProgressRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/progress/get"
        urlBuilder_.Append("achievement/progress/get");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<AchievementProgressResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new BeyondImmersion.Bannou.Core.ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    /// <returns>Progress updated successfully</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<UpdateAchievementProgressResponse> UpdateAchievementProgressAsync(UpdateAchievementProgressRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/progress/update"
        urlBuilder_.Append("achievement/progress/update");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<UpdateAchievementProgressResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new BeyondImmersion.Bannou.Core.ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    /// <returns>Achievement unlocked successfully</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<UnlockAchievementResponse> UnlockAchievementAsync(UnlockAchievementRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/unlock"
        urlBuilder_.Append("achievement/unlock");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<UnlockAchievementResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new BeyondImmersion.Bannou.Core.ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
                    ...
                    {
                        string responseText_ = ( response_.Content == null ) ? string.Empty : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
                        throw new BeyondImmersion.Bannou.Core.ApiException("Achievement already unlocked", status_, responseText_, headers_, null);
                    }
                    else
                    {
                        var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
    ...
    /// <returns>Unlocked achievements retrieved successfully</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<ListUnlockedAchievementsResponse> ListUnlockedAchievementsAsync(ListUnlockedAchievementsRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/list-unlocked"
        urlBuilder_.Append("achievement/list-unlocked");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<ListUnlockedAchievementsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new BeyondImmersion.Bannou.Core.ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    /// <returns>Sync completed</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<SyncPlatformAchievementsResponse> SyncPlatformAchievementsAsync(SyncPlatformAchievementsRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/platform/sync"
        urlBuilder_.Append("achievement/platform/sync");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<SyncPlatformAchievementsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new BeyondImmersion.Bannou.Core.ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    /// <returns>Sync status retrieved successfully</returns>
    /// <exception cref="BeyondImmersion.Bannou.Core.ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<PlatformSyncStatusResponse> GetPlatformSyncStatusAsync(GetPlatformSyncStatusRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (body == null)
            throw new System.ArgumentNullException("body");
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/platform/status"
        urlBuilder_.Append("achievement/platform/status");
            ...
            methodPath_))
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<PlatformSyncStatusResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new BeyondImmersion.Bannou.Core.ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    public virtual async System.Threading.Tasks.Task<CleanupByCharacterResponse> CleanupByCharacterAsync(CleanupByCharacterRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        // Build method path (without base URL - mesh client handles endpoint resolution)
        var urlBuilder_ = new System.Text.StringBuilder();
        // Operation Path: "achievement/cleanup-by-character"
        urlBuilder_.Append("achievement/cleanup-by-character");
