...
public static class MappingPermissionRegistration
{
    ...
    public static ICollection<ServiceEndpoint> GetEndpoints()
    {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/mapping/release-authority",
            Method = ServiceEndpointMethod.POST,
            Description = "releaseAuthority",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/mapping/authority-heartbeat",
            Method = ServiceEndpointMethod.POST,
            Description = "authorityHeartbeat",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/mapping/publish",
            Method = ServiceEndpointMethod.POST,
            Description = "publishMapUpdate",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/mapping/publish-objects",
            Method = ServiceEndpointMethod.POST,
            Description = "publishObjectChanges",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
