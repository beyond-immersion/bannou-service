...
// =============================================================================
// LeaderboardService — Private & Internal Helper Methods
// =============================================================================
//
// This partial class file is the designated home for all private and internal
// helper methods used by LeaderboardService. This separation exists to
// support the IMPLEMENTATION TENETS telemetry span rules:
//
//   - PRIMARY FILE (LeaderboardService.cs):
//     Contains ONLY public interface method implementations (the methods
//     declared in ILeaderboardService). These methods MUST NOT call
...
//
//   - THIS FILE (LeaderboardService.Helpers.cs):
...
/// <summary>
/// Private and internal helper methods for LeaderboardService.
/// </summary>
/// <remarks>
/// <para>
...
{
    // Move private/internal helper methods here from LeaderboardService.cs
}
