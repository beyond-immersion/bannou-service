...
//     1. Edit x-permissions sections in schemas/leaderboard-api.yaml
...
/// <summary>
/// Generated permission registration for Leaderboard service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class LeaderboardPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "leaderboard";
    ...
    public static ICollection<ServiceEndpoint> GetEndpoints()
    {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/leaderboard/definition/clean-deprecated",
            Method = ServiceEndpointMethod.Post,
            Description = "cleanDeprecatedLeaderboardDefinitions",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
...
/// <summary>
/// Partial class overlay: registers Leaderboard service permissions via DI registry.
/// Generated from x-permissions sections in leaderboard-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                LeaderboardPermissionRegistration.ServiceId,
                LeaderboardPermissionRegistration.ServiceVersion,
                LeaderboardPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
