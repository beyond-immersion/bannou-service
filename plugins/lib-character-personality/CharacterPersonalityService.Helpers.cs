...
// =============================================================================
// CharacterPersonalityService — Private & Internal Helper Methods
// =============================================================================
//
// This partial class file is the designated home for all private and internal
// helper methods used by CharacterPersonalityService. This separation exists to
// support the IMPLEMENTATION TENETS telemetry span rules:
//
//   - PRIMARY FILE (CharacterPersonalityService.cs):
//     Contains ONLY public interface method implementations (the methods
//     declared in ICharacterPersonalityService). These methods MUST NOT call
...
//
//   - THIS FILE (CharacterPersonalityService.Helpers.cs):
...
/// <summary>
/// Private and internal helper methods for CharacterPersonalityService.
/// </summary>
/// <remarks>
/// <para>
...
{
    // Move private/internal helper methods here from CharacterPersonalityService.cs
}
