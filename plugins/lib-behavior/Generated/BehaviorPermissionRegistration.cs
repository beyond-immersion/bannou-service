//----------------------
// <auto-generated>
//     Generated from OpenAPI schema: schemas/behavior-api.yaml
//
...
//     1. Edit x-permissions sections in schemas/behavior-api.yaml
...
/// <summary>
/// Generated permission registration for Behavior service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class BehaviorPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "behavior";
...
/// <summary>
/// Partial class overlay: registers Behavior service permissions via DI registry.
/// Generated from x-permissions sections in behavior-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                BehaviorPermissionRegistration.ServiceId,
                BehaviorPermissionRegistration.ServiceVersion,
                BehaviorPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
