...
/// <summary>
/// Partial class overlay: registers Voice service permissions via DI registry.
/// Generated from x-permissions sections in voice-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                VoicePermissionRegistration.ServiceId,
                VoicePermissionRegistration.ServiceVersion,
                VoicePermissionRegistration.BuildPermissionMatrix());
        }
    }
}
