...
//     1. Edit x-permissions sections in schemas/analytics-api.yaml
...
/// <summary>
/// Generated permission registration for Analytics service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class AnalyticsPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "analytics";
...
/// <summary>
/// Partial class overlay: registers Analytics service permissions via DI registry.
/// Generated from x-permissions sections in analytics-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                AnalyticsPermissionRegistration.ServiceId,
                AnalyticsPermissionRegistration.ServiceVersion,
                AnalyticsPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
