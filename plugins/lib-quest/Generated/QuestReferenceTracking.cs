...
/// <summary>
/// Generated partial class providing resource reference tracking helpers for QuestService.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
[ResourceCleanupRequired("DeleteByCharacterAsync")]
public partial class QuestService
{

    /// <summary>
    /// Registers a reference from a quest entity to a character resource.
    /// Call this after creating an entity that references the resource.
    /// </summary>
    /// <param name="questId">The ID of the quest entity holding the reference.</param>
    ...
    /// <summary>
    /// Unregisters a reference from a quest entity to a character resource.
    /// Call this before deleting an entity that references the resource.
    /// </summary>
    /// <param name="questId">The ID of the quest entity releasing the reference.</param>
        ...
        try
        {
            await resourceClient.DefineCleanupCallbackAsync(
                new DefineCleanupRequest
                {
                    ...
                    ServiceName = "quest",
                    CallbackEndpoint = "/quest/delete-by-character",
                    PayloadTemplate = "{\"characterId\": \"{{resourceId}}\"}",
                    Description = "Cleanup quest entities referencing deleted character"
                },
                cancellationToken);
        }
        catch (ApiException)
