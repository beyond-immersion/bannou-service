...
// =============================================================================
// PuppetmasterService — Private & Internal Helper Methods
// =============================================================================
//
// This partial class file is the designated home for all private and internal
// helper methods used by PuppetmasterService. This separation exists to
// support the IMPLEMENTATION TENETS telemetry span rules:
//
//   - PRIMARY FILE (PuppetmasterService.cs):
//     Contains ONLY public interface method implementations (the methods
//     declared in IPuppetmasterService). These methods MUST NOT call
...
//
//   - THIS FILE (PuppetmasterService.Helpers.cs):
...
/// <summary>
/// Private and internal helper methods for PuppetmasterService.
/// </summary>
/// <remarks>
/// <para>
...
{
    // Move private/internal helper methods here from PuppetmasterService.cs
}
