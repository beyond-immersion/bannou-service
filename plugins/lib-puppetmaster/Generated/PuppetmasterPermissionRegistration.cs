...
//     1. Edit x-permissions sections in schemas/puppetmaster-api.yaml
...
/// <summary>
/// Generated permission registration for Puppetmaster service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class PuppetmasterPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "puppetmaster";
...
/// <summary>
/// Partial class overlay: registers Puppetmaster service permissions via DI registry.
/// Generated from x-permissions sections in puppetmaster-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                PuppetmasterPermissionRegistration.ServiceId,
                PuppetmasterPermissionRegistration.ServiceVersion,
                PuppetmasterPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
