...
//     1. Edit x-permissions sections in schemas/status-api.yaml
...
/// <summary>
/// Generated permission registration for Status service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class StatusPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "status";
    ...
    public static ICollection<ServiceEndpoint> GetEndpoints()
    {
        ...
        {
            Path = "/status/template/create",
            Method = ServiceEndpointMethod.POST,
            Description = "createStatusTemplate",
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/status/template/get",
            Method = ServiceEndpointMethod.POST,
            Description = "getStatusTemplate",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/status/template/get-by-code",
            Method = ServiceEndpointMethod.POST,
            Description = "getStatusTemplateByCode",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/status/template/list",
            Method = ServiceEndpointMethod.POST,
            Description = "listStatusTemplates",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/status/template/update",
            Method = ServiceEndpointMethod.POST,
            Description = "updateStatusTemplate",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/status/template/seed",
            Method = ServiceEndpointMethod.POST,
            Description = "seedStatusTemplates",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/status/remove-by-source",
            Method = ServiceEndpointMethod.POST,
            Description = "removeBySource",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/status/remove-by-category",
            Method = ServiceEndpointMethod.POST,
            Description = "removeByCategory",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/status/effects/get",
            Method = ServiceEndpointMethod.POST,
            Description = "getEffects",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
...
/// <summary>
/// Partial class overlay: registers Status service permissions via DI registry.
/// Generated from x-permissions sections in status-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                StatusPermissionRegistration.ServiceId,
                StatusPermissionRegistration.ServiceVersion,
                StatusPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
