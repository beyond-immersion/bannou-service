...
/// <summary>
/// Partial class overlay: registers Inventory service permissions via DI registry.
/// Generated from x-permissions sections in inventory-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                InventoryPermissionRegistration.ServiceId,
                InventoryPermissionRegistration.ServiceVersion,
                InventoryPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
