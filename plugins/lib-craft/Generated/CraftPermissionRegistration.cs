...
//     1. Edit x-permissions sections in schemas/craft-api.yaml
...
/// <summary>
/// Generated permission registration for Craft service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class CraftPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "craft";
    ...
    public static ICollection<ServiceEndpoint> GetEndpoints()
    {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/craft/recipe/deprecate",
            Method = ServiceEndpointMethod.Post,
            Description = "deprecateRecipe",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/craft/recipe/seed",
            Method = ServiceEndpointMethod.Post,
            Description = "seedRecipes",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/craft/recipe/clean-deprecated",
            Method = ServiceEndpointMethod.Post,
            Description = "cleanDeprecatedRecipes",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/craft/proficiency/grant",
            Method = ServiceEndpointMethod.Post,
            Description = "grantExperience",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/craft/proficiency/set",
            Method = ServiceEndpointMethod.Post,
            Description = "setProficiency",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/craft/station/register",
            Method = ServiceEndpointMethod.Post,
            Description = "registerStation",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/craft/station/deregister",
            Method = ServiceEndpointMethod.Post,
            Description = "deregisterStation",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
...
/// <summary>
/// Partial class overlay: registers Craft service permissions via DI registry.
/// Generated from x-permissions sections in craft-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                CraftPermissionRegistration.ServiceId,
                CraftPermissionRegistration.ServiceVersion,
                CraftPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
