//----------------------
// <auto-generated>
//     Generated from OpenAPI schema: schemas/game-service-api.yaml
//
...
//     1. Edit x-permissions sections in schemas/game-service-api.yaml
...
/// <summary>
/// Generated permission registration for GameService service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class GameServicePermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "game-service";
...
/// <summary>
/// Partial class overlay: registers GameService service permissions via DI registry.
/// Generated from x-permissions sections in game-service-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                GameServicePermissionRegistration.ServiceId,
                GameServicePermissionRegistration.ServiceVersion,
                GameServicePermissionRegistration.BuildPermissionMatrix());
        }
    }
}
