//----------------------
// <auto-generated>
//     Generated from OpenAPI schema: schemas/game-service-configuration.yaml
//
...
//     1. Edit the source schema (schemas/game-service-configuration.yaml)
...
//     - ALL properties below MUST be referenced in GameServiceService.cs (no dead config).
...
//
//     Example: public MyService(GameServiceServiceConfiguration config) { _config = config; }
//
...
/// <summary>
/// Configuration class for GameService service.
...
/// </para>
/// </remarks>
[ServiceConfiguration(typeof(GameServiceService))]
