...
// =============================================================================
// GenesisService — Private & Internal Helper Methods
// =============================================================================
//
// This partial class file is the designated home for all private and internal
// helper methods used by GenesisService. This separation exists to
// support the IMPLEMENTATION TENETS telemetry span rules:
//
//   - PRIMARY FILE (GenesisService.cs):
//     Contains ONLY public interface method implementations (the methods
//     declared in IGenesisService). These methods MUST NOT call
...
//
//   - THIS FILE (GenesisService.Helpers.cs):
...
{
    // Move private/internal helper methods here from GenesisService.cs
}
