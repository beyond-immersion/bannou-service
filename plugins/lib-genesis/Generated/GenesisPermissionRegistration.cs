...
//     1. Edit x-permissions sections in schemas/genesis-api.yaml
...
/// <summary>
/// Generated permission registration for Genesis service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class GenesisPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "genesis";
    ...
    public static ICollection<ServiceEndpoint> GetEndpoints()
    {
        ...
        {
            Path = "/genesis/template/register",
            Method = ServiceEndpointMethod.Post,
            Description = "registerTemplate",
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/genesis/template/deprecate",
            Method = ServiceEndpointMethod.Post,
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/genesis/template/clean-deprecated",
            Method = ServiceEndpointMethod.Post,
            Description = "cleanDeprecated",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/genesis/restore-from-archive",
            Method = ServiceEndpointMethod.Post,
...
/// <summary>
/// Partial class overlay: registers Genesis service permissions via DI registry.
/// Generated from x-permissions sections in genesis-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                GenesisPermissionRegistration.ServiceId,
                GenesisPermissionRegistration.ServiceVersion,
                GenesisPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
