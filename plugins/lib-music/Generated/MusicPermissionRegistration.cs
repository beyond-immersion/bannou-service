...
/// <summary>
/// Partial class overlay: registers Music service permissions via DI registry.
/// Generated from x-permissions sections in music-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                MusicPermissionRegistration.ServiceId,
                MusicPermissionRegistration.ServiceVersion,
                MusicPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
