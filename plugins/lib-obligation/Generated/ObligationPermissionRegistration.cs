...
//     1. Edit x-permissions sections in schemas/obligation-api.yaml
...
/// <summary>
/// Generated permission registration for Obligation service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class ObligationPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "obligation";
...
/// <summary>
/// Partial class overlay: registers Obligation service permissions via DI registry.
/// Generated from x-permissions sections in obligation-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                ObligationPermissionRegistration.ServiceId,
                ObligationPermissionRegistration.ServiceVersion,
                ObligationPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
