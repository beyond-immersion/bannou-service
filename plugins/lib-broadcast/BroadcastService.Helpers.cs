...
// =============================================================================
// BroadcastService — Private & Internal Helper Methods
// =============================================================================
//
// This partial class file is the designated home for all private and internal
// helper methods used by BroadcastService. This separation exists to
// support the IMPLEMENTATION TENETS telemetry span rules:
//
//   - PRIMARY FILE (BroadcastService.cs):
//     Contains ONLY public interface method implementations (the methods
//     declared in IBroadcastService). These methods MUST NOT call
...
//
//   - THIS FILE (BroadcastService.Helpers.cs):
...
/// <summary>
/// Private and internal helper methods for BroadcastService.
/// </summary>
/// <remarks>
/// <para>
...
{
    // Move private/internal helper methods here from BroadcastService.cs
}
