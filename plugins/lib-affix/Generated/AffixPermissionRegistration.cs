...
//     1. Edit x-permissions sections in schemas/affix-api.yaml
...
/// <summary>
/// Generated permission registration for Affix service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class AffixPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "affix";
    ...
    public static ICollection<ServiceEndpoint> GetEndpoints()
    {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/affix/definition/deprecate",
            Method = ServiceEndpointMethod.Post,
            Description = "deprecateDefinition",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/affix/definition/seed",
            Method = ServiceEndpointMethod.Post,
            Description = "seedDefinitions",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/affix/definition/list-mod-groups",
            Method = ServiceEndpointMethod.Post,
            Description = "listModGroups",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/affix/definition/clean-deprecated",
            Method = ServiceEndpointMethod.Post,
            Description = "cleanDeprecatedDefinitions",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/affix/implicit/create",
            Method = ServiceEndpointMethod.Post,
            Description = "createImplicitMapping",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/affix/implicit/get",
            Method = ServiceEndpointMethod.Post,
            Description = "getImplicitMapping",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/affix/implicit/seed",
            Method = ServiceEndpointMethod.Post,
            Description = "seedImplicitMappings",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/affix/implicit/roll",
            Method = ServiceEndpointMethod.Post,
            Description = "rollImplicits",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
...
/// <summary>
/// Partial class overlay: registers Affix service permissions via DI registry.
/// Generated from x-permissions sections in affix-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                AffixPermissionRegistration.ServiceId,
                AffixPermissionRegistration.ServiceVersion,
                AffixPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
