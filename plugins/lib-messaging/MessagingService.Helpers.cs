...
// =============================================================================
// MessagingService — Private & Internal Helper Methods
// =============================================================================
//
// This partial class file is the designated home for all private and internal
// helper methods used by MessagingService. This separation exists to
// support the IMPLEMENTATION TENETS telemetry span rules:
//
//   - PRIMARY FILE (MessagingService.cs):
//     Contains ONLY public interface method implementations (the methods
//     declared in IMessagingService). These methods MUST NOT call
...
//
//   - THIS FILE (MessagingService.Helpers.cs):
...
/// <summary>
/// Private and internal helper methods for MessagingService.
/// </summary>
/// <remarks>
/// <para>
...
{
    // Move private/internal helper methods here from MessagingService.cs
}
