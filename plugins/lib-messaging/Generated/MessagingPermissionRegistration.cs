...
//     1. Edit x-permissions sections in schemas/messaging-api.yaml
...
/// <summary>
/// Generated permission registration for Messaging service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class MessagingPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "messaging";
...
/// <summary>
/// Partial class overlay: registers Messaging service permissions via DI registry.
/// Generated from x-permissions sections in messaging-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                MessagingPermissionRegistration.ServiceId,
                MessagingPermissionRegistration.ServiceVersion,
                MessagingPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
