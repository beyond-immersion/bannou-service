...
//     1. Edit x-permissions sections in schemas/telemetry-api.yaml
...
/// <summary>
/// Generated permission registration for Telemetry service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class TelemetryPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "telemetry";
...
/// <summary>
/// Partial class overlay: registers Telemetry service permissions via DI registry.
/// Generated from x-permissions sections in telemetry-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                TelemetryPermissionRegistration.ServiceId,
                TelemetryPermissionRegistration.ServiceVersion,
                TelemetryPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
