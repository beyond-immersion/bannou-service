...
// =============================================================================
// TelemetryService — Private & Internal Helper Methods
// =============================================================================
//
// This partial class file is the designated home for all private and internal
// helper methods used by TelemetryService. This separation exists to
// support the IMPLEMENTATION TENETS telemetry span rules:
//
//   - PRIMARY FILE (TelemetryService.cs):
//     Contains ONLY public interface method implementations (the methods
//     declared in ITelemetryService). These methods MUST NOT call
...
//
//   - THIS FILE (TelemetryService.Helpers.cs):
...
/// <summary>
/// Private and internal helper methods for TelemetryService.
/// </summary>
/// <remarks>
/// <para>
...
{
    // Move private/internal helper methods here from TelemetryService.cs
}
