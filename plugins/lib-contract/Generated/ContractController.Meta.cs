...
""";
    ...
    #region Meta Endpoints for CleanDeprecatedContractTemplates

    private static readonly string _CleanDeprecatedContractTemplates_RequestSchema = """
{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "type": "object"
}
""";
    ...
    private static readonly string _CleanDeprecatedContractTemplates_ResponseSchema = """
{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "type": "object"
}
""";
    ...
    private static readonly string _CleanDeprecatedContractTemplates_Info = """
{
    "summary": "Clean deprecated contract templates with zero remaining instances",
    "description": "Category B cleanup sweep (per IMPLEMENTATION TENETS). Iterates all deprecated\ncontract templates and permanently removes those with zero remaining contract\ninstances, subject to an optional grace period. Publishes template.deleted events\nfor each removed template. Idempotent and safe to call at any frequency.\nSupports dry-run mode for admin panel preview.\n",
    "tags": [
        "Templates"
    ],
    "deprecated": false,
    "operationId": "cleanDeprecatedContractTemplates"
}
""";

    /// <summary>Returns endpoint information for CleanDeprecatedContractTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/contract/template/clean-deprecated/meta/info")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedContractTemplates_MetaInfo()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildInfoResponse(
            "Contract",
            "POST",
            "/contract/template/clean-deprecated",
            _CleanDeprecatedContractTemplates_Info));

    /// <summary>Returns request schema for CleanDeprecatedContractTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/contract/template/clean-deprecated/meta/request-schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedContractTemplates_MetaRequestSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildSchemaResponse(
            "Contract",
            "POST",
            "/contract/template/clean-deprecated",
            "request-schema",
            _CleanDeprecatedContractTemplates_RequestSchema));

    /// <summary>Returns response schema for CleanDeprecatedContractTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/contract/template/clean-deprecated/meta/response-schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedContractTemplates_MetaResponseSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildSchemaResponse(
            "Contract",
            "POST",
            "/contract/template/clean-deprecated",
            "response-schema",
            _CleanDeprecatedContractTemplates_ResponseSchema));

    /// <summary>Returns full schema for CleanDeprecatedContractTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/contract/template/clean-deprecated/meta/schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedContractTemplates_MetaFullSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildFullSchemaResponse(
            "Contract",
            "POST",
            "/contract/template/clean-deprecated",
