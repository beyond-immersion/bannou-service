...
// =============================================================================
// CharacterHistoryService — Private & Internal Helper Methods
// =============================================================================
//
// This partial class file is the designated home for all private and internal
// helper methods used by CharacterHistoryService. This separation exists to
// support the IMPLEMENTATION TENETS telemetry span rules:
//
//   - PRIMARY FILE (CharacterHistoryService.cs):
//     Contains ONLY public interface method implementations (the methods
//     declared in ICharacterHistoryService). These methods MUST NOT call
...
//
//   - THIS FILE (CharacterHistoryService.Helpers.cs):
...
/// <summary>
/// Private and internal helper methods for CharacterHistoryService.
/// </summary>
/// <remarks>
/// <para>
...
{
    // Move private/internal helper methods here from CharacterHistoryService.cs
}
