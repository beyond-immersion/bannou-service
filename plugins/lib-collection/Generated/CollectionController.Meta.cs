...
""";
    ...
    #region Meta Endpoints for CleanDeprecatedEntryTemplates

    private static readonly string _CleanDeprecatedEntryTemplates_RequestSchema = """
{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "type": "object"
}
""";
    ...
    private static readonly string _CleanDeprecatedEntryTemplates_ResponseSchema = """
{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "type": "object"
}
""";
    ...
    private static readonly string _CleanDeprecatedEntryTemplates_Info = """
{
    "summary": "Clean deprecated entry templates with zero remaining entries",
    "description": "Category B cleanup sweep (per IMPLEMENTATION TENETS). Iterates all deprecated\nentry templates and permanently removes those with zero remaining unlocked entries,\nsubject to an optional grace period. Publishes entry-template.deleted events for\neach removed template. Idempotent and safe to call at any frequency.\nSupports dry-run mode for admin panel preview.\n",
    "tags": [
        "EntryTemplate"
    ],
    "deprecated": false,
    "operationId": "cleanDeprecatedEntryTemplates"
}
""";

    /// <summary>Returns endpoint information for CleanDeprecatedEntryTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/collection/entry-template/clean-deprecated/meta/info")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedEntryTemplates_MetaInfo()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildInfoResponse(
            "Collection",
            "POST",
            "/collection/entry-template/clean-deprecated",
            _CleanDeprecatedEntryTemplates_Info));

    /// <summary>Returns request schema for CleanDeprecatedEntryTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/collection/entry-template/clean-deprecated/meta/request-schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedEntryTemplates_MetaRequestSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildSchemaResponse(
            "Collection",
            "POST",
            "/collection/entry-template/clean-deprecated",
            "request-schema",
            _CleanDeprecatedEntryTemplates_RequestSchema));

    /// <summary>Returns response schema for CleanDeprecatedEntryTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/collection/entry-template/clean-deprecated/meta/response-schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedEntryTemplates_MetaResponseSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildSchemaResponse(
            "Collection",
            "POST",
            "/collection/entry-template/clean-deprecated",
            "response-schema",
            _CleanDeprecatedEntryTemplates_ResponseSchema));

    /// <summary>Returns full schema for CleanDeprecatedEntryTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/collection/entry-template/clean-deprecated/meta/schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedEntryTemplates_MetaFullSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildFullSchemaResponse(
            "Collection",
            "POST",
            "/collection/entry-template/clean-deprecated",
