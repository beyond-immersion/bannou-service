...
public class GenesisServiceEntityTests : ServiceTestBase<GenesisServiceConfiguration>
{
    ...
    public async Task CreateEntityAsync_DuplicateCode_ReturnsConflict()
    {
        ...
        _mockEntityStore.Setup(s => s.GetAsync(It.Is<string>(k => k.StartsWith("entity-code:")), It.IsAny<CancellationToken>())).ReturnsAsync(CreateTestEntity());
    ...
    public async Task CreateEntityAsync_ValidRequest_ProvisionsSeedWalletsInventories()
    {
        ...
        _mockEntityStore.Setup(s => s.GetAsync(It.Is<string>(k => k.StartsWith("entity-code:")), It.IsAny<CancellationToken>())).ReturnsAsync((GenesisEntityModel?)null);
