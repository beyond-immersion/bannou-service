    ...
    private static readonly string _DeprecateScenarioDefinition_Info = """
{
    ...
    "description": "Category B deprecation (per IMPLEMENTATION TENETS): one-way, no undeprecate,\nno delete. Idempotent \u2014 returns OK if already deprecated.\ nDeprecated scenarios are not returned by find-available.\n",
    "tags": [
        "Scenario Definitions"
    ],
    "deprecated": false,
...
""";
    ...
    #region Meta Endpoints for CleanDeprecatedScenarioDefinitions

    private static readonly string _CleanDeprecatedScenarioDefinitions_RequestSchema = """
{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "type": "object"
}
""";
    ...
    private static readonly string _CleanDeprecatedScenarioDefinitions_ResponseSchema = """
{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "type": "object"
}
""";
    ...
    private static readonly string _CleanDeprecatedScenarioDefinitions_Info = """
{
    "summary": "Clean deprecated scenario definitions with zero remaining instances",
    "description": "Category B cleanup sweep (per IMPLEMENTATION TENETS). Iterates all deprecated\nscenario definitions and permanently removes those with zero remaining active\nstoryline instances, subject to an optional grace period. Publishes\nscenario-definition.deleted events for each removed definition.\nIdempotent and safe to call at any frequency.\ nSupports dry-run mode for admin panel preview.\n",
    "tags": [
        "Scenario Definitions"
    ],
    "deprecated": false,
    "operationId": "CleanDeprecatedScenarioDefinitions"
}
""";

    /// <summary>Returns endpoint information for CleanDeprecatedScenarioDefinitions</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/storyline/scenario/clean-deprecated/meta/info")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedScenarioDefinitions_MetaInfo()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildInfoResponse(
            "Storyline",
            "POST",
            "/storyline/scenario/clean-deprecated",
            _CleanDeprecatedScenarioDefinitions_Info));

    /// <summary>Returns request schema for CleanDeprecatedScenarioDefinitions</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/storyline/scenario/clean-deprecated/meta/request-schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedScenarioDefinitions_MetaRequestSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildSchemaResponse(
            "Storyline",
            "POST",
            "/storyline/scenario/clean-deprecated",
            "request-schema",
            _CleanDeprecatedScenarioDefinitions_RequestSchema));

    /// <summary>Returns response schema for CleanDeprecatedScenarioDefinitions</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/storyline/scenario/clean-deprecated/meta/response-schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedScenarioDefinitions_MetaResponseSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildSchemaResponse(
            "Storyline",
            "POST",
            "/storyline/scenario/clean-deprecated",
            "response-schema",
            _CleanDeprecatedScenarioDefinitions_ResponseSchema));

    /// <summary>Returns full schema for CleanDeprecatedScenarioDefinitions</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/storyline/scenario/clean-deprecated/meta/schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedScenarioDefinitions_MetaFullSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildFullSchemaResponse(
            "Storyline",
            "POST",
            "/storyline/scenario/clean-deprecated",
