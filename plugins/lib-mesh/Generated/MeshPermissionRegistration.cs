...
public static class MeshPermissionRegistration
{
    ...
    public static ICollection<ServiceEndpoint> GetEndpoints()
    {
        ...
        {
            Path = "/mesh/endpoints/get",
            Method = ServiceEndpointMethod.POST,
            Description = "getEndpoints",
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/mesh/endpoints/list",
            Method = ServiceEndpointMethod.POST,
            Description = "listEndpoints",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/mesh/deregister",
            Method = ServiceEndpointMethod.POST,
            Description = "deregisterEndpoint",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
