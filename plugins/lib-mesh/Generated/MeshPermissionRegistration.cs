...
//     1. Edit x-permissions sections in schemas/mesh-api.yaml
...
/// <summary>
/// Generated permission registration for Mesh service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class MeshPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "mesh";
...
/// <summary>
/// Partial class overlay: registers Mesh service permissions via DI registry.
/// Generated from x-permissions sections in mesh-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                MeshPermissionRegistration.ServiceId,
                MeshPermissionRegistration.ServiceVersion,
                MeshPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
