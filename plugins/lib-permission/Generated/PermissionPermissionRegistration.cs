...
/// <summary>
/// Partial class overlay: registers Permission service permissions via DI registry.
/// Generated from x-permissions sections in permission-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                PermissionPermissionRegistration.ServiceId,
                PermissionPermissionRegistration.ServiceVersion,
                PermissionPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
