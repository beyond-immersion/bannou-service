...
/// <summary>
/// Partial class overlay: registers Asset service permissions via DI registry.
/// Generated from x-permissions sections in asset-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                AssetPermissionRegistration.ServiceId,
                AssetPermissionRegistration.ServiceVersion,
                AssetPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
