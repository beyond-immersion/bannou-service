...
//     1. Edit x-permissions sections in schemas/arbitration-api.yaml
...
/// <summary>
/// Generated permission registration for Arbitration service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class ArbitrationPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "arbitration";
...
/// <summary>
/// Partial class overlay: registers Arbitration service permissions via DI registry.
/// Generated from x-permissions sections in arbitration-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                ArbitrationPermissionRegistration.ServiceId,
                ArbitrationPermissionRegistration.ServiceVersion,
                ArbitrationPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
