...
// =============================================================================
// RealmHistoryService — Private & Internal Helper Methods
// =============================================================================
//
// This partial class file is the designated home for all private and internal
// helper methods used by RealmHistoryService. This separation exists to
// support the IMPLEMENTATION TENETS telemetry span rules:
//
//   - PRIMARY FILE (RealmHistoryService.cs):
//     Contains ONLY public interface method implementations (the methods
//     declared in IRealmHistoryService). These methods MUST NOT call
...
//
//   - THIS FILE (RealmHistoryService.Helpers.cs):
...
/// <summary>
/// Private and internal helper methods for RealmHistoryService.
/// </summary>
/// <remarks>
/// <para>
...
{
    // Move private/internal helper methods here from RealmHistoryService.cs
}
