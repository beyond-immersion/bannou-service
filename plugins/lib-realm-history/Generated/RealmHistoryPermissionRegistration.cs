...
//     1. Edit x-permissions sections in schemas/realm-history-api.yaml
...
/// <summary>
/// Generated permission registration for RealmHistory service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class RealmHistoryPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "realm-history";
...
/// <summary>
/// Partial class overlay: registers RealmHistory service permissions via DI registry.
/// Generated from x-permissions sections in realm-history-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                RealmHistoryPermissionRegistration.ServiceId,
                RealmHistoryPermissionRegistration.ServiceVersion,
                RealmHistoryPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
