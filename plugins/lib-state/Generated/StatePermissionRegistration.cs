...
//     1. Edit x-permissions sections in schemas/state-api.yaml
...
/// <summary>
/// Partial class overlay: registers State service permissions via DI registry.
/// Generated from x-permissions sections in state-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                StatePermissionRegistration.ServiceId,
                StatePermissionRegistration.ServiceVersion,
                StatePermissionRegistration.BuildPermissionMatrix());
        }
    }
}
