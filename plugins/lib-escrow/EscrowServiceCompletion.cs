        ...
        CancellationToken cancellationToken = default)
    {
        ...
        for (var attempt = 0; attempt < _configuration.MaxConcurrencyRetries; attempt++)
        {
            ...
            if (previousStatus == EscrowStatus.Finalizing && requiresPartyConfirmation)
            {
                ...
                await _statusIndexStore.SaveAsync(initiationNewStatusKey, initiationStatusEntry, cancellationToken: cancellationToken);
                ...
                await _messageBus.PublishEscrowReleasingAsync(releasingEvent, cancellationToken);
