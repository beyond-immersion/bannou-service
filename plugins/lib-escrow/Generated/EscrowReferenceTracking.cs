...
/// <summary>
/// Generated partial class providing resource reference tracking helpers for EscrowService.
/// </summary>
/// <remarks>
/// <para>
...
public partial class EscrowService
{
    ...
    /// <summary>
    /// Registers a reference from a escrow entity to a character resource.
    /// Call this after creating an entity that references the resource.
    /// </summary>
    /// <param name="escrowId">The ID of the escrow entity holding the reference.</param>
    ...
    /// <summary>
    /// Unregisters a reference from a escrow entity to a character resource.
    /// Call this before deleting an entity that references the resource.
    /// </summary>
    /// <param name="escrowId">The ID of the escrow entity releasing the reference.</param>
        ...
        try
        {
            await resourceClient.DefineCleanupCallbackAsync(
                new DefineCleanupRequest
                {
                    ...
                    ServiceName = "escrow",
                    CallbackEndpoint = "/escrow/cleanup-by-character",
                    PayloadTemplate = "{\"characterId\": \"{{resourceId}}\"}",
                    Description = "Cleanup escrow entities referencing deleted character"
                },
                cancellationToken);
        }
        catch (ApiException)
