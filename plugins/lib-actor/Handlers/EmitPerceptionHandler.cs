...
public sealed class EmitPerceptionHandler : IActionHandler
{
        ...
        CancellationToken ct)
    {
        ...
        var sourceType = sourceTypeStr.MapByNameOrDefault(PerceptionSourceType.Coordinator);
        ...
        var perceptionEvent = new CharacterPerceptionEvent
        {
            ...
            SourceAppId = _config.LocalModeAppId, // Event Brain runs within Bannou per IMPLEMENTATION TENETS (no hardcoded tunables)
