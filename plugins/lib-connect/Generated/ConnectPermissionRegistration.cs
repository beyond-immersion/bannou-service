...
//     1. Edit x-permissions sections in schemas/connect-api.yaml
...
/// <summary>
/// Partial class overlay: registers Connect service permissions via DI registry.
/// Generated from x-permissions sections in connect-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                ConnectPermissionRegistration.ServiceId,
                ConnectPermissionRegistration.ServiceVersion,
                ConnectPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
