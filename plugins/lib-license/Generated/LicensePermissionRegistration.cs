...
public static class LicensePermissionRegistration
{
    ...
    public static ICollection<ServiceEndpoint> GetEndpoints()
    {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/license/board-template/clean-deprecated",
            Method = ServiceEndpointMethod.Post,
            Description = "cleanDeprecatedBoardTemplates",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
...
/// <summary>
/// Partial class overlay: registers License service permissions via DI registry.
/// Generated from x-permissions sections in license-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                LicensePermissionRegistration.ServiceId,
                LicensePermissionRegistration.ServiceVersion,
                LicensePermissionRegistration.BuildPermissionMatrix());
        }
    }
}
