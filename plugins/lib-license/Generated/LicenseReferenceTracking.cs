...
/// <summary>
/// Generated partial class providing resource reference tracking helpers for LicenseService.
/// </summary>
/// <remarks>
/// <para>
...
public partial class LicenseService
{
    ...
    /// <summary>
    /// Registers a reference from a license-board entity to a character resource.
    /// Call this after creating an entity that references the resource.
    /// </summary>
    /// <param name="licenseBoardId">The ID of the license-board entity holding the reference.</param>
    ...
    /// <summary>
    /// Unregisters a reference from a license-board entity to a character resource.
    /// Call this before deleting an entity that references the resource.
    /// </summary>
    /// <param name="licenseBoardId">The ID of the license-board entity releasing the reference.</param>
