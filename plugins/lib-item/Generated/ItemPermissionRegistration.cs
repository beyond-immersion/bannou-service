...
//     1. Edit x-permissions sections in schemas/item-api.yaml
...
/// <summary>
/// Generated permission registration for Item service.
/// Contains permission matrix extracted from x-permissions sections in OpenAPI schema.
/// </summary>
public static class ItemPermissionRegistration
{
    /// <summary>
    /// Service ID for permission registration.
    /// </summary>
    public const string ServiceId = "item";
    ...
    public static ICollection<ServiceEndpoint> GetEndpoints()
    {
        ...
        endpoints.Add(new ServiceEndpoint
        {
            Path = "/item/template/clean-deprecated",
            Method = ServiceEndpointMethod.Post,
            Description = "cleanDeprecatedItemTemplates",
            Permissions = new List<PermissionRequirement>
            {
                new PermissionRequirement
                {
...
/// <summary>
/// Partial class overlay: registers Item service permissions via DI registry.
/// Generated from x-permissions sections in item-api.yaml.
        ...
        string appId, IPermissionRegistry? registry)
    {
        if (registry != null)
        {
            await registry.RegisterServiceAsync(
                ItemPermissionRegistration.ServiceId,
                ItemPermissionRegistration.ServiceVersion,
                ItemPermissionRegistration.BuildPermissionMatrix());
        }
    }
}
