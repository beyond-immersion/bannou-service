...
""";
    ...
    #region Meta Endpoints for CleanDeprecatedItemTemplates

    private static readonly string _CleanDeprecatedItemTemplates_RequestSchema = """
{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "type": "object"
}
""";
    ...
    private static readonly string _CleanDeprecatedItemTemplates_ResponseSchema = """
{
    "$schema": "http://json-schema.org/draft-07/schema#",
    "type": "object"
}
""";
    ...
    private static readonly string _CleanDeprecatedItemTemplates_Info = """
{
    "summary": "Clean deprecated item templates with zero remaining instances",
    "description": "Category B cleanup sweep (per IMPLEMENTATION TENETS). Iterates all deprecated\nitem templates and permanently removes those with zero remaining item instances,\nsubject to an optional grace period. Publishes item-template.deleted events for\neach removed template. Idempotent and safe to call at any frequency.\nSupports dry-run mode for admin panel preview.\n",
    "tags": [
        "Item Template"
    ],
    "deprecated": false,
    "operationId": "cleanDeprecatedItemTemplates"
}
""";

    /// <summary>Returns endpoint information for CleanDeprecatedItemTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/item/template/clean-deprecated/meta/info")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedItemTemplates_MetaInfo()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildInfoResponse(
            "Item",
            "POST",
            "/item/template/clean-deprecated",
            _CleanDeprecatedItemTemplates_Info));

    /// <summary>Returns request schema for CleanDeprecatedItemTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/item/template/clean-deprecated/meta/request-schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedItemTemplates_MetaRequestSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildSchemaResponse(
            "Item",
            "POST",
            "/item/template/clean-deprecated",
            "request-schema",
            _CleanDeprecatedItemTemplates_RequestSchema));

    /// <summary>Returns response schema for CleanDeprecatedItemTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/item/template/clean-deprecated/meta/response-schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedItemTemplates_MetaResponseSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildSchemaResponse(
            "Item",
            "POST",
            "/item/template/clean-deprecated",
            "response-schema",
            _CleanDeprecatedItemTemplates_ResponseSchema));

    /// <summary>Returns full schema for CleanDeprecatedItemTemplates</summary>
    [Microsoft.AspNetCore.Mvc.HttpGet, Microsoft.AspNetCore.Mvc.Route("/item/template/clean-deprecated/meta/schema")]
    public Microsoft.AspNetCore.Mvc.ActionResult<BeyondImmersion.BannouService.Meta.MetaResponse> CleanDeprecatedItemTemplates_MetaFullSchema()
        => Ok(BeyondImmersion.BannouService.Meta.MetaResponseBuilder.BuildFullSchemaResponse(
            "Item",
            "POST",
            "/item/template/clean-deprecated",
