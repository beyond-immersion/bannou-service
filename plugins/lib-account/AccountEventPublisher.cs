...
/// <summary>
/// Type-safe event publisher for Account service events.
/// Provides strongly-typed methods for publishing account lifecycle events.
/// </summary>
/// <remarks>
/// This class could be auto-generated from schemas/account-events.yaml.
/// Topic naming convention: {entity}.{action} (e.g., "account.created").
/// </remarks>
public class AccountEventPublisher : EventPublisherBase
{
    ...
    /// <summary>
    /// Creates an AccountEventPublisher with the specified dependencies.
    /// </summary>
    /// <param name="messageBus">Message bus for publishing events.</param>
    /// <param name="logger">Logger for event operations.</param>
    public AccountEventPublisher(IMessageBus messageBus, ILogger<AccountEventPublisher> logger)
