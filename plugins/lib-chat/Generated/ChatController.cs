...
public interface IChatController : BeyondImmersion.BannouService.Controllers.IBannouController
{
    ...
    System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.ActionResult<CleanDeprecatedResponse>> CleanDeprecatedRoomTypes(CleanDeprecatedRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
...
public partial class ChatController : Microsoft.AspNetCore.Mvc.ControllerBase, IChatController
{
    ...
    /// </remarks>
    /// <returns>Cleanup sweep completed</returns>
    [Microsoft.AspNetCore.Mvc.HttpPost, Microsoft.AspNetCore.Mvc.Route("chat/type/clean-deprecated")]

    public async System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.ActionResult<CleanDeprecatedResponse>> CleanDeprecatedRoomTypes([Microsoft.AspNetCore.Mvc.FromBody] [Microsoft.AspNetCore.Mvc.ModelBinding.BindRequired] CleanDeprecatedRequest body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {

        using var activity_ = _telemetryProvider.StartActivity(
            "bannou.chat",
            "ChatController.CleanDeprecatedRoomTypes",
            System.Diagnostics.ActivityKind.Server);
        activity_?.SetTag("http.route", "chat/type/clean-deprecated");
        try
        {

            var (statusCode, result) = await _implementation.CleanDeprecatedRoomTypesAsync(body, cancellationToken);
            return ConvertToActionResult(statusCode, result);
        }
        catch (BeyondImmersion.Bannou.Core.ApiException ex_)
        {
            var logger_ = Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<Microsoft.Extensions.Logging.ILogger<ChatController>>(HttpContext.RequestServices);
            Microsoft.Extensions.Logging.LoggerExtensions.LogWarning(logger_, ex_, "Dependency error in {Endpoint}", "post:chat/type/clean-deprecated");
            activity_?.SetStatus(System.Diagnostics.ActivityStatusCode.Error, "Dependency error");
            return StatusCode(503);
        }
        catch (System.Exception ex_)
        {
            var logger_ = Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<Microsoft.Extensions.Logging.ILogger<ChatController>>(HttpContext.RequestServices);
            Microsoft.Extensions.Logging.LoggerExtensions.LogError(logger_, ex_, "Unexpected error in {Endpoint}", "post:chat/type/clean-deprecated");
            var messageBus_ = Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<BeyondImmersion.BannouService.Services.IMessageBus>(HttpContext.RequestServices);
            await messageBus_.TryPublishErrorAsync(
                "chat",
                ...
                "unexpected_exception",
                ex_.Message,
                endpoint: "post:chat/type/clean-deprecated",
                stack: ex_.StackTrace,
                cancellationToken: cancellationToken);
            activity_?.SetStatus(System.Diagnostics.ActivityStatusCode.Error, ex_.Message);
            return StatusCode(500);
