...
public class CharacterEncounterServiceTests : ServiceTestBase<CharacterEncounterServiceConfiguration>
{
    ...
    public async Task UpdatePerspectiveAsync_PublishesUpdatedEvent()
    {
        ...
        _mockPerspectiveStore.Setup(s => s.TrySaveAsync(It.IsAny<string>(), It.IsAny<PerspectiveData>(), It.IsAny<string>(), It.IsAny<StateOptions?>(), It.IsAny<CancellationToken>())).ReturnsAsync("etag-1");
