...
// =============================================================================
// WebsiteService — Private & Internal Helper Methods
// =============================================================================
//
// This partial class file is the designated home for all private and internal
// helper methods used by WebsiteService. This separation exists to
// support the IMPLEMENTATION TENETS telemetry span rules:
//
//   - PRIMARY FILE (WebsiteService.cs):
//     Contains ONLY public interface method implementations (the methods
//     declared in IWebsiteService). These methods MUST NOT call
...
//
//   - THIS FILE (WebsiteService.Helpers.cs):
...
/// <summary>
/// Private and internal helper methods for WebsiteService.
/// </summary>
/// <remarks>
/// <para>
...
{
    // Move private/internal helper methods here from WebsiteService.cs
}
