...
> **Related**: [ABML Guide](./ABML.md) | [Actors Plugin](../planning/UPCOMING_-_ACTORS_PLUGIN_V3.md)
...
*For actor execution and the cognition pipeline, see [Actors Plugin](../planning/UPCOMING_-_ACTORS_PLUGIN_V3.md).*
