...
**Patron deity**: Characters carry an optional `patronDeityCode` (opaque string, nullable). This is the authoritative source of truth for a character's current patron deity. Character stores and returns the code opaquely — all interpretation happens in Divine (L4), which subscribes to `character.created` and `character.updated` events with `changedFields` to detect patron changes and auto-bond/rebond character domain seeds. Set by Divine, Character Lifecycle (generational inheritance), game extensions, or god-actor ABML behavior. Not every character has a patron (orphans, godless cultures, characters outside divine territory).
...
**Deep Dive**: [docs/plugins/DIRECTOR.md](../plugins/DIRECTOR.md) | **Map**: [docs/maps/DIRECTOR.md](../maps/DIRECTOR.md)
...
**Deep Dive**: [docs/plugins/DISPOSITION.md](../plugins/DISPOSITION.md) | **Map**: [docs/maps/DISPOSITION.md](../maps/DISPOSITION.md)
...
**Version**: 1.0.0 | **Schema**: `schemas/music-api.yaml` | **Endpoints**: 8 | **Deep Dive**: [docs/plugins/MUSIC.md](../plugins/MUSIC.md) | **Map**: [docs/maps/MUSIC.md](../maps/MUSIC.md)
