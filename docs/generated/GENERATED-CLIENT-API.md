...
| [Bannou Localization Service API](#localization) | `client.Localization` | 12 | Multi-language translation tables with category lifecycle, p... |
...
## Bannou Localization Service API {#localization}

**Proxy**: `client.Localization` | **Version**: 1.0.0

Multi-language translation tables with category lifecycle, pronunciation annotations, bulk export, and DI-based key validation for cross-service lo...

### Category

| Method | Request | Response | Summary |
|--------|---------|----------|---------|
| `CreateCategoryAsync` | `CreateCategoryRequest` | `CategoryResponse` | Create a runtime localization category |
| `GetCategoryAsync` | `GetCategoryRequest` | `CategoryResponse` | Get a localization category by ID or code |
| `ListCategoriesAsync` | `ListCategoriesRequest` | `ListCategoriesResponse` | List localization categories |
| `UpdateCategoryAsync` | `UpdateCategoryRequest` | `CategoryResponse` | Update a localization category |
| `DeleteCategoryAsync` | `DeleteCategoryRequest` | `DeleteCategoryResponse` | Delete a runtime localization category |

### Entry

| Method | Request | Response | Summary |
|--------|---------|----------|---------|
| `SetentryAsync` | `SetEntryRequest` | `EntryResponse` | Upsert a localization entry |
| `GetEntryAsync` | `GetEntryRequest` | `EntryResponse` | Get a specific localization entry |
| `ListEntriesAsync` | `ListEntriesRequest` | `ListEntriesResponse` | List localization entries |
| `DeleteEntryAsync` | `DeleteEntryRequest` | `DeleteEntryResponse` | Delete a localization entry |
| `BulksetentriesAsync` | `BulkSetEntriesRequest` | `BulkSetEntriesResponse` | Bulk upsert localization entries |

### Export

| Method | Request | Response | Summary |
|--------|---------|----------|---------|
| `ExportlocalizationAsync` | `ExportRequest` | `ExportResponse` | Export compiled localization bundle |
| `ExportplsAsync` | `ExportPlsRequest` | `ExportPlsResponse` | Export W3C PLS pronunciation lexicon |
