...
| `character-encounter.encounter-type.deleted` | `EncounterTypeDeletedEvent` | Unused Category B infrastructure — encounter types are never deleted (T31). Generated by `x-lifecycle` for future safe deletion pattern. |
