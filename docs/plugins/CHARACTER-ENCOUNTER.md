...
| `resource.reference.registered` | `ResourceReferenceRegisteredEvent` | Character reference registered after encounter creation (generated by x-references) |
| `resource.reference.unregistered` | `ResourceReferenceUnregisteredEvent` | Character reference unregistered before deletion (generated by x-references) |
