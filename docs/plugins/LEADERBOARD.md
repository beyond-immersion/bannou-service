...
| `leaderboard.definition.deleted` | `LeaderboardDefinitionDeletedEvent` | Unused Category B infrastructure — definitions are never deleted (T31). Generated by `x-lifecycle` for future safe deletion pattern. |
