...
**Incidental enchanting**: Because pneuma carries intent through logos-patterned materials, all crafting in a mana-rich environment is inherently an act of enchantment. A crafter's emotional state, professional biases, and accumulated expertise flow through their work as trace logos patterns (Type 2: intent-channeling enchantments). Novice crafters imbue imperceptible trace intent unconsciously; master crafters can deliberately hold and direct intent during forging; grandmaster crafters inscribe powerful, coherent intent patterns that shape wielders' behavior and personality over time. Cultural traditions prescribing emotional hygiene during crafting ("never forge in anger," "sing while you bake") are empirically-discovered intent suppression practices. Items produced via Workshop's lazy evaluation carry no intent — automated production has no crafter personality to imprint. See [EQUIPMENT-ENCHANTMENT-DUALITY.md](../planning/EQUIPMENT-ENCHANTMENT-DUALITY.md) for the full design of the enchantment duality system, including environmental mana tiers, personality drift, immune individuals, and the Vonnegut principle ("we are what we pretend to be").
