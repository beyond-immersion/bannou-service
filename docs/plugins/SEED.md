...
- [#712](https://github.com/beyond-immersion/bannou-service/issues/712) - Bond growth propagation: PropagationDirection/PropagationRatio per-bond fields, anti-cascade `propagated` flag, batched SeedBondPropagationWorker (confirmed 2026-03-19; depends on #362; prerequisite for Divine patron deity divinity generation)
- [#713](https://github.com/beyond-immersion/bannou-service/issues/713) - Batch `seed.growth.updated` events for 100K+ scale (prerequisite for Divine/Genesis at scale; follows BATCH-LIFECYCLE-EVENTS.md pattern)
- [#413](https://github.com/beyond-immersion/bannou-service/issues/413) - Faction diplomacy via seed bonds (confirmed 2026-03-19; consumer of #712 propagation feature)
