...
public class GameSessionServicePlugin : BaseBannouPlugin
{
    ...
    protected override async Task<bool> OnStartAsync()
    {
        ...
        try
        {
            ...
            {
                Logger?.LogDebug("Calling IBannouService.OnStartAsync for GameSession service");
    ...
    protected override async Task OnRunningAsync()
    {
        ...
        try
        {
            ...
            if (_service is IBannouService bannouService)
            {
                Logger?.LogDebug("Calling IBannouService.OnRunningAsync for GameSession service");
    ...
    protected override async Task OnShutdownAsync()
    {
        ...
        try
        {
            ...
            if (_service is IBannouService bannouService)
            {
                Logger?.LogDebug("Calling IBannouService.OnShutdownAsync for GameSession service");
