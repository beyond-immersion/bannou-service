...
log_info "🔐 Generating client event whitelist"
...
echo -e "${YELLOW}📄 Scanning client event schemas...${NC}"
...
if [ ${#EVENT_NAMES[@]} -eq 0 ]; then
    echo -e "${YELLOW}⚠️  No event names found in schemas${NC}"
...
echo ""
echo -e "${BLUE}📝 Generating whitelist file...${NC}"
...
echo -e "${GREEN}✅ Whitelist generated successfully${NC}"
echo -e "   📁 Output: $OUTPUT_FILE"
echo -e "   📊 Event count: ${#UNIQUE_EVENTS[@]}"
echo ""
...
echo -e "${YELLOW}💡 Usage: ClientEventWhitelist.IsValidEventName(eventName)${NC}"
