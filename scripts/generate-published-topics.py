...
Architecture:
- {service}-service-events.yaml: Contains x-event-publications in the info block
...
// This code was generated by generate-published-topics.py from {service_name}-service-events.yaml.
...
/// </summary>
/// <remarks>
/// Generated from <c>x-event-publications</c> in <c>{service_name}-service-events.yaml</c>.
/// </remarks>
