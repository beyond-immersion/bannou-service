...
<!--
  ============================================================================
  THIS FILE IS GENERATED BY scripts/generate-client-sdk.sh
  ============================================================================
  DO NOT EDIT THIS FILE DIRECTLY. Your changes will be overwritten.

  If you need to add new dependencies (base classes, interfaces, shared files),
  edit scripts/generate-client-sdk.sh and regenerate.
  ============================================================================
-->
