...
public class PermissionsServicePlugin : BaseBannouPlugin
{
    ...
    public override void ConfigureServices(IServiceCollection services)
    {
        ...
        // IDistributedLockProvider is now registered by lib-state's StateServicePlugin
        // (uses native Redis SET NX EX pattern)
    ...
    protected override async Task<bool> OnStartAsync()
    {
        ...
        try
        {
            ...
            {
                Logger?.LogDebug("Calling IBannouService.OnStartAsync for Permissions service");
    ...
    protected override async Task OnRunningAsync()
    {
        ...
        try
        {
            ...
            if (_service is IBannouService bannouService)
            {
                Logger?.LogDebug("Calling IBannouService.OnRunningAsync for Permissions service");
    ...
    protected override async Task OnShutdownAsync()
    {
        ...
        try
        {
            ...
            if (_service is IBannouService bannouService)
            {
                Logger?.LogDebug("Calling IBannouService.OnShutdownAsync for Permissions service");
