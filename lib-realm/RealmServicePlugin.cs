...
public class RealmServicePlugin : BaseBannouPlugin
{
    ...
    public override void ConfigureServices(IServiceCollection services)
    {
        ...
        // No need to register RealmServiceConfiguration here
    ...
    protected override async Task<bool> OnStartAsync()
    {
        ...
        try
        {
            ...
            _service = scope?.ServiceProvider.GetService<IRealmService>();

            if (_service == null)
            {
                Logger?.LogError("Failed to resolve IRealmService from DI container");
                return false;
            }
