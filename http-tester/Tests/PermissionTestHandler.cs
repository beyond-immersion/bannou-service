...
/// <summary>
/// Test handler for permission service API endpoints, including event subscription tests.
...
public class PermissionTestHandler : BaseHttpTestHandler
{
    ...
    [
        ...
        new ServiceTest(TestEventSubscription, "EventSubscription", "Permission", "Test RabbitMQ pubsub event subscription for service registration"),
        new ServiceTest(TestSessionStateChangeEvent, "SessionStateChangeEvent", "Permission", "Test RabbitMQ pubsub event subscription for session state changes"),
