...
/// <summary>
/// Unit tests for AccountEventPublisher.
/// Tests event publishing for account lifecycle events.
/// </summary>
public class AccountEventPublisherTests
{
    private readonly Mock<IMessageBus> _mockMessageBus;
    private readonly Mock<ILogger<AccountEventPublisher>> _mockLogger;
    private readonly AccountEventPublisher _publisher;

    public AccountEventPublisherTests()
    {
        _mockMessageBus = new Mock<IMessageBus>();
        _mockLogger = new Mock<ILogger<AccountEventPublisher>>();

        _publisher = new AccountEventPublisher(
    ...
    {
        ServiceConstructorValidator.ValidateServiceConstructor<AccountEventPublisher>();
