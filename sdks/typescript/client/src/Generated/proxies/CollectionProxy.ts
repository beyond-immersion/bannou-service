...
export class CollectionProxy {
  ...
  async selectContentForAreaAsync(
    ...
    return this.client.invokeAsync<Schemas['SelectContentForAreaRequest'], Schemas['ContentSelectionResponse']>(
  ...
  async setAreaContentConfigAsync(
    ...
    return this.client.invokeAsync<Schemas['SetAreaContentConfigRequest'], Schemas['AreaContentConfigResponse']>(
  ...
  async getAreaContentConfigAsync(
    ...
    return this.client.invokeAsync<Schemas['GetAreaContentConfigRequest'], Schemas['AreaContentConfigResponse']>(
  ...
  async listAreaContentConfigsAsync(
    ...
    return this.client.invokeAsync<Schemas['ListAreaContentConfigsRequest'], Schemas['ListAreaContentConfigsResponse']>(
