...
public sealed class ResourceProxy
{
    ...
    /// <param name="timeout">Request timeout.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>ApiResponse containing ListSeededResourcesResponse on success.</returns>
    public Task<ApiResponse<ListSeededResourcesResponse>> ListSeededResourcesAsync(
        ListSeededResourcesRequest request,
        ushort channel = 0,
        TimeSpan? timeout = null,
        CancellationToken cancellationToken = default)
    {
        return _client.InvokeAsync<ListSeededResourcesRequest, ListSeededResourcesResponse>(
            "/resource/seeded/list", request, channel, timeout, cancellationToken);
    }
    ...
    /// <param name="timeout">Request timeout.</param>
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>ApiResponse containing GetSeededResourceResponse on success.</returns>
    public Task<ApiResponse<GetSeededResourceResponse>> GetSeededResourceAsync(
        GetSeededResourceRequest request,
        ushort channel = 0,
        TimeSpan? timeout = null,
        CancellationToken cancellationToken = default)
    {
