...
public sealed class StorylineProxy
{
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>ApiResponse containing ScenarioDefinition on success.</returns>
    public Task<ApiResponse<ScenarioDefinition>> DeprecateScenarioDefinitionAsync(
        DeprecateScenarioDefinitionRequest request,
        ushort channel = 0,
        TimeSpan? timeout = null,
        CancellationToken cancellationToken = default)
    {
        return _client.InvokeAsync<DeprecateScenarioDefinitionRequest, ScenarioDefinition>(
            "/storyline/scenario/deprecate", request, channel, timeout, cancellationToken);
    }
