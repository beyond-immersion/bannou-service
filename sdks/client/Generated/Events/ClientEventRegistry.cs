...
public static class ClientEventRegistry
{
    private static readonly Dictionary<Type, string> TypeToEventName = new()
    {
        ...
        { typeof(SessionCapabilitiesEvent), "permission.session_capabilities" },
        { typeof(SessionStateChangedEvent), "game_session.state_changed" },
        { typeof(ShortcutPublishedEvent), "session.shortcut_published" },
        { typeof(ShortcutRevokedEvent), "session.shortcut_revoked" },
    ...
    private static readonly Dictionary<string, Type> EventNameToType = new()
    {
        ...
        { "permission.session_capabilities", typeof(SessionCapabilitiesEvent) },
        { "session.shortcut_published", typeof(ShortcutPublishedEvent) },
        { "session.shortcut_revoked", typeof(ShortcutRevokedEvent) },
