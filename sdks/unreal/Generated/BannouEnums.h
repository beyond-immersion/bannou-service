...
{
    RagsToRiches UMETA(DisplayName = "rags_to_riches"),
    Tragedy UMETA(DisplayName = "tragedy"),
    ManInHole UMETA(DisplayName = "man_in_hole"),
...
{
    LifeDeath UMETA(DisplayName = "life_death"),
    HonorDishonor UMETA(DisplayName = "honor_dishonor"),
    JusticeInjustice UMETA(DisplayName = "justice_injustice"),
    FreedomSubjugation UMETA(DisplayName = "freedom_subjugation"),
    LoveHate UMETA(DisplayName = "love_hate"),
    RespectShame UMETA(DisplayName = "respect_shame"),
    PowerImpotence UMETA(DisplayName = "power_impotence"),
    SuccessFailure UMETA(DisplayName = "success_failure"),
    AltruismSelfishness UMETA(DisplayName = "altruism_selfishness"),
    WisdomIgnorance UMETA(DisplayName = "wisdom_ignorance"),
};
