...
{
    VoiceGallery UMETA(DisplayName = "voice_gallery"),
    SceneArchive UMETA(DisplayName = "scene_archive"),
    EndingGallery UMETA(DisplayName = "ending_gallery"),
    MusicLibrary UMETA(DisplayName = "music_library"),
    Bestiary UMETA(DisplayName = "bestiary"),
    RecipeBook UMETA(DisplayName = "recipe_book"),
    Custom UMETA(DisplayName = "custom"),
};
