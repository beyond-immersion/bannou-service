...
// Generated by generate-unreal-types.py on 2026-02-12 02:30:58 UTC
...
struct FLeaveVoidRequest;
struct FLeaveVoidResponse;
...
struct FSharedVoidStateResponse;
...
struct FPhaseConfigResponse
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bannou")
    bool VoidMinigamesEnabled = false;
...
struct FSharedVoidStateResponse
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bannou")
    TArray<FBondedPlayerVoidState> Participants;
