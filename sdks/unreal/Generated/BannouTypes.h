...
// Generated by generate-unreal-types.py on 2026-02-05 06:58:20 UTC
...
struct FActionEffect
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bannou")
    TOptional<ECardinality> Cardinality;
...
struct FPhaseTargetState
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bannou")
    TMap<FString, FString> NarrativeState;
...
struct FStorylinePlanPhase
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bannou")
    TOptional<FPhaseTargetState> TargetState;

    /** Position bounds for this phase (0-1 story progress) */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Bannou")
    TOptional<FPhasePosition> PositionBounds;
